...
// OEM keys
#define VK_OEM_1 0xBA       // For US standard keyboard, the ';:' key
...
#define VK_OEM_2 0xBF       // For US standard keyboard, the '/?' key
#define VK_OEM_3 0xC0       // For US standard keyboard, the '`~' key
// 0xC1-0xDA Reserved
#define VK_OEM_4 0xDB  // For US standard keyboard, the '[{' key
#define VK_OEM_5 0xDC  // For US standard keyboard, the '\|' key
#define VK_OEM_6 0xDD  // For US standard keyboard, the ']}' key
#define VK_OEM_7 0xDE  // For US standard keyboard, the ''"' key
#define VK_OEM_8 0xDF  // Miscellaneous characters
// 0xE0 Reserved
// 0xE1 OEM specific
#define VK_OEM_102 0xE2  // <> or \| on non-US keyboards
// 0xE3-0xE4 OEM specific
#define VK_PROCESSKEY 0xE5  // IME PROCESS key
// 0xE6 OEM specific
#define VK_PACKET 0xE7  // Used to pass Unicode characters as keystrokes
// 0xE8 Unassigned
